...
public class PlayerSetup : MonoBehaviourPunCallbacks
{
    ...
    void Start()
    {
        if(FPSCamera == null) Debug.LogError("FPSCamera is null");
    ...
    void SetPlayerUI(){
        if(playerNameText == null) Debug.Log("playerNameText is null");
        else playerNameText.text = photonView.Owner.NickName; // Set player´s name
    }
